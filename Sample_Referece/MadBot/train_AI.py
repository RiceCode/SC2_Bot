...
model.add(Flatten())
model.add(Dense(300, activation=tf.nn.relu, input_dim=54))  # a simple fully-connected layer, 150 units, relu activation
...
tensorboard = TensorBoard(log_dir="logs/5")
# Train the model
model.fit(X, y, epochs=10000, callbacks=[tensorboard], validation_split=0.3)

model.save("MadAI_24_02_2019")
